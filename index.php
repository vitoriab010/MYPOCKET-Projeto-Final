            ...
            <div class="col-md-8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="Calendario.php" class="btn btn-outline-dark me-3">📅 Ver Calendário Anual</a>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped m-0">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-4">Nenhuma transação registrada até o momento.</td>
                                    </tr>
                                <?php else: ?>
                                    <?php /** @var Transacao $t */ ?>
